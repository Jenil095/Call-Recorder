...
public class RecordAdapter extends RecyclerView.Adapter<RecordAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(RecordAdapter.MyViewHolder holder, int position) {
        ...
        holder.bind(cd1.getDate(), cd1.getNum(), cd1.getTime());
        switch (getItemViewType(position)) {
            case 0:
                ...
                holder.time.setText(callDetails.get(position).getTime());
                break;
            case 2:
                holder.date.setText(callDetails.get(position).getDate());
                if(name!=null && !name.equals("")) {
                    holder.name.setText(name);
                    holder.name.setTextColor(context.getResources().getColor(R.color.colorPrimaryDark));
                }
