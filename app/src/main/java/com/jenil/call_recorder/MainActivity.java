...
public class MainActivity extends AppCompatActivity {
    ...
    com.jenil.call_recorder.DatabaseHandler db=new com.jenil.call_recorder.DatabaseHandler(this);
    final static String TAGMA="Main Activity";
    com.jenil.call_recorder.RecordAdapter rAdapter;
    RecyclerView recycler;
    List<com.jenil.call_recorder.CallDetails> callDetailsList;
    ...
    public void setUi()
    {
        ...
        callDetailsList=new com.jenil.call_recorder.DatabaseManager(this).getAllDetails();

        for(com.jenil.call_recorder.CallDetails cd:callDetailsList)
        {
            String log="Phone num : "+cd.getNum()+" | Time : "+cd.getTime()+" | Date : "+cd.getDate();
            Log.d("Database ", log);
        }
        Collections.reverse(callDetailsList);
        rAdapter=new com.jenil.call_recorder.RecordAdapter(callDetailsList,this);
